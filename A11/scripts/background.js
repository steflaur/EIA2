...
(function (A11_canvas) {
    ...
    //function Wasser
    function drawWater(_color1, _color2, _x, _y, _r1, _r2) {
        //Wasser
    ...
    //function Boden & Kies
    function drawBottom(_color1, _color2, _nK, _x, _y) {
        //Boden
        ...
        A11_canvas.crc2.fillStyle = _color1;
    ...
    //function für Kies
    function drawStones(_colorF, _colorS, _x, _y, _r) {
        A11_canvas.crc2.beginPath();
        A11_canvas.crc2.arc(_x, _y, _r, 0, 2 * Math.PI);
        A11_canvas.crc2.strokeStyle = _colorS;
        A11_canvas.crc2.stroke();
        A11_canvas.crc2.fillStyle = _colorF;
        A11_canvas.crc2.fill();
        A11_canvas.crc2.closePath();
    }
    A11_canvas.drawStones = drawStones;
    //function plant
    function drawPlant(_color1, _color2, _color3, _x, _y) {
        //Pflanze mitte
        //Stiel
        A11_canvas.crc2.beginPath();
        A11_canvas.crc2.moveTo(_x, _y);
        ...
        A11_canvas.crc2.strokeStyle = _color3;
        A11_canvas.crc2.stroke();
        A11_canvas.crc2.closePath();
        //Blatt
        A11_canvas.crc2.beginPath();
        ...
        A11_canvas.crc2.fillStyle = _color2;
        A11_canvas.crc2.fill();
        A11_canvas.crc2.closePath();
        //Pflanze rechts
        //Stiel
    ...
    function drawBubbler(_color1, _color2, _x, _y) {
        //Hinten
        A11_canvas.crc2.strokeStyle = "black";
        A11_canvas.crc2.fillStyle = _color2;
        A11_canvas.crc2.beginPath();
