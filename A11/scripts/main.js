...
(function (A11_canvas) {
    ...
    function init() {
        ...
        A11_canvas.crc2.strokeRect(0, 0, canvas.width, canvas.height);
        //Wasser
        A11_canvas.drawWater("lightblue", "skyblue", canvas.width, canvas.height, 10, 400);
        //Boden
        A11_canvas.drawBottom("burlywood", "peru", 700, 0, 400);
        //Schatzkiste
        A11_canvas.drawBubbler("saddlebrown", "#5a2d0c", 350, 520);
        //Pflanzen
        A11_canvas.drawPlant("green", "darkgreen", "brown", 85, 400);
        A11_canvas.drawPlant("green", "darkgreen", "brown", 700, 500);
        ...
        for (let i = 0; i < nF; i++) {
            ...
            fish.x = Math.random() * A11_canvas.crc2.canvas.width;
